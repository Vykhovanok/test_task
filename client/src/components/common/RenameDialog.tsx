...
export class RenameDialog extends Component<Props> {
  ...
  render() {
    ...
    return (
      <DialogShell>
        <h2 className="text-base font-semibold text-slate-900">Rename</h2>
        <p className="mt-1 text-sm text-slate-500">Enter a new name for this resource.</p>
        <input
          autoFocus
